...
function filterLinks() {
  ...
  links.each(function (index, link) {
    var title = link.children[1].textContent.split(": ")[1].toLowerCase();
    var url = link.children[2].textContent.split("URL: ")[1].toLowerCase();
...
function markAsRead(e) {
  ...
  $.ajax({
    ...
    url: "/api/v1/links/" + linkId,
    data: { read: true }
  }).then(addHotRead(urlForHotLinks)).fail(displayFailure);
}
