...
function displayAddFailure(failureData) {
  ...
  $('form').append("\n    <div class=\"alert alert-warning\">\n      <strong>Oops! </strong>" + failureData.responseJSON.message + "\n    </div>\n  ");
  clearAlert();
...
function makeFieldsEditable(e) {
  e.preventDefault();
  $(e.target).hide();
  var submitButton = $('<input type="button" class="update-link-button" value="Update Link"/>');
